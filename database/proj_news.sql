...
--
-- Host: localhost:3306
-- Generation Time: May 24, 2023 at 07:13 AM
...
CREATE TABLE `category` (
  ...
  `display` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL
...
CREATE TABLE `user` (
  ...
  `level` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `created_by` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  `modified_by` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `status` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=COMPACT;
